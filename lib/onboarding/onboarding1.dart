...
import 'package:finans/onboarding/onboarding2.dart';
      ...
      body: Scaffold(
        ...
        Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/onboarding1_background.png'),
              fit: BoxFit.cover,
            ),
          ),
        ...
        child:
           Column(
            ...
            children: [
              Text("Luxury and Comfort, Just a Tap Away",
              style: TextStyle(
                fontSize: 28.02.sp,
   ...
   SizedBox(
              ...
              Button(onPressed: (){
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) =>  OnBoarding2Widget())
                );
